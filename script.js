...
// Constante du padding pour éviter le rognage lors de la rotation
const PADDING_FACTOR = 1.4; // Multiplier la taille par 1.4 pour laisser 40% de marge
    ...
    if (file) {
        ...
        reader.onload = function(e) {
            originalImage.onload = function() {
                ...
                // --- AJOUT CLÉ 1: Calculer la nouvelle taille du Canvas ---
                // Le Canvas est agrandi pour accueillir la rotation complète sans rognage.
                canvas.width = originalImage.width * PADDING_FACTOR;
                canvas.height = originalImage.height * PADDING_FACTOR;
